...
echo -e "\n\033[1;33mNote on Domain Mapping to 'yourdomain.com':\033[0m"
echo -e "To point this service to a subdomain like \033[1;34mhpai.yourdomain.com\033[0m, follow either:"
echo -e "\n\033[1;35mOption A (Direct CNAME Integration - Easiest):\033[0m"
echo -e "1. Run command:"
echo -e "   \033[1;36mgcloud beta run domain-mappings create --service=${SERVICE_NAME} --domain=hpai.yourdomain.com --region=${REGION}\033[0m"
echo -e "2. Add the provided DNS TXT/CNAME records inside your yourdomain.com registrar domain configuration."
...
echo -e "3. Add an A record for hpai.yourdomain.com pointing to the Load Balancer IP."
echo -e "==================================================================="
